...
import { a as requireReact } from '../../../chunks/_@astro-renderers_q5lUqFY3.mjs';
export { r as renderers } from '../../../chunks/_@astro-renderers_q5lUqFY3.mjs';
  ...
  collections: {
    ...
    projets: collection({
      ...
      schema: {
        ...
        featured: index.checkbox({
          label: "Mettre en avant sur la homepage",
          defaultValue: false
        }),
        results: index.array(
          index.text({ label: "Résultat" }),
          {
